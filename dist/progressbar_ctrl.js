...
System.register(['app/plugins/sdk', 'lodash', 'app/core/utils/kbn', 'app/core/time_series', './css/progress.css!'], function (_export, _context) {
  "use strict";

  var MetricsPanelCtrl, _, kbn, TimeSeries, _createClass, ProgressBarCtrl;
    ...
    execute: function () {
      ...
      _export('ProgressBarCtrl', ProgressBarCtrl = function (_MetricsPanelCtrl) {
        ...
        _createClass(ProgressBarCtrl, [{
          ...
          key: 'changeLegendColor',
          value: function changeLegendColor(selectedSeries, selectedColor) {
